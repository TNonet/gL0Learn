...
arma::uvec inline coordinate_iter_order(const std::size_t num_coords,
                                        bool shuffle) {
  if (num_coords == 0) {
    return {};
  }
...
coordinate_vector inline upper_triangle_coordinate_vector(const arma::uword p) {
...
coordinate_vector inline union_of_correlated_features(
    const arma::mat &x, const double correlation_threshold) {
  /*
...
arma::umat inline unravel_ut_indices(const arma::uvec &transposed_indices,
                                     const arma::uword p) {
  /*
...
arma::umat inline union_of_correlated_features2(
    const arma::mat &x, const double correlation_threshold) {
  /*
...
coordinate_vector inline coordinate_vector_from_matrix(
...
arma::umat inline coordinate_matrix_from_vector(
    const coordinate_vector &coord_vec) {
...
coordinate_vector inline support_from_active_set(
    const arma::mat &x, const coordinate_vector &active_set) {
...
coordinate_vector inline sorted_vector_difference2(
    const coordinate_vector &larger, const coordinate_vector &smaller) {
  /*
...
coordinate_vector inline insert_sorted_vector_into_sorted_vector(
    const coordinate_vector &x1, const coordinate_vector &x2) {
  /*
