...
void init_fit(py::module_ &m) {
  ...
  m.def("_fit", &fit<PenaltyL0<double>, NoBounds>,
        py::call_guard<py::scoped_ostream_redirect,
                       py::scoped_estream_redirect>());
  m.def("_fit", &fit<PenaltyL0L1<double>, NoBounds>,
        py::call_guard<py::scoped_ostream_redirect,
                       py::scoped_estream_redirect>());
  m.def("_fit", &fit<PenaltyL0L2<double>, NoBounds>,
        py::call_guard<py::scoped_ostream_redirect,
                       py::scoped_estream_redirect>());
  m.def("_fit", &fit<PenaltyL0L1L2<double>, NoBounds>,
        py::call_guard<py::scoped_ostream_redirect,
                       py::scoped_estream_redirect>());
}
...
//     const arma::umat &super_active_set, const double tol,
//     const size_t max_active_set_size, const size_t max_iter, const size_t
//     seed, const size_t max_swaps, const bool shuffle_feature_order);
//
