...
template const fitmodel _fit<PenaltyL0<double>, NoBounds>(const arma::mat& Y,
                                                          const arma::mat& theta_init,
                                                          const PenaltyL0<double>& penalty,
...
template const fitmodel _fit<PenaltyL0L2<double>, NoBounds>(const arma::mat& Y,
                                                            const arma::mat& theta_init,
                                                            const PenaltyL0L2<double>& penalty,
                                                            const NoBounds& bounds,
                                                            const std::string algorithm,
                                                            const arma::umat& initial_active_set,
                                                            const arma::umat& super_active_set,
